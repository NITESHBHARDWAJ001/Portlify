...
export default function AuthShell({ children, eyebrow, title, description, badgeText }) {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0B0F1A] text-[#E5E7EB]">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[1200px] flex-col px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="grid flex-1 items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <section className="flex justify-center lg:justify-end">
            <div className="glass-panel brand-glow w-full max-w-xl rounded-[28px] border border-white/10 p-4 sm:p-6 lg:p-8">
              <div className="mb-6 flex items-center justify-between gap-3 rounded-2xl border border-white/8 bg-white/5 p-4">
                <div>
              ...
              <div className="mt-6 rounded-2xl border border-[#06B6D4]/20 bg-gradient-to-r from-[#7C3AED]/15 to-[#06B6D4]/15 p-4">
